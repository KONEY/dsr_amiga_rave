...
__SCROLL_X_1_4_BIS:
	...
	BSR	WaitBlitterNasty		; BLITTER SHOULD BE FAST ENOUGH
	MOVE.W	D7,(A6)			; PATCH LOST WORD
	; ## MAIN BLIT ####
	RTS
...
__BLOCK_TEST:
	...
	MOVE.B	#$1,BLIT_COLUMN		; BLIT VERTICALLY ALL PLANES
	;###############################
	...
	;MOVE.L	#$10000,BLIT_A_MOD
	MOVE.B	#$0,BLIT_COLUMN		; DONT BLIT VERTICALLY
	;###############################
	NEG.W	D3
	LEA	BGPLANE1,A3
	MOVE.L	A3,A4
...
TEXTURE:		;INCBIN "PurpleT_160x640x3.raw"
		...
		;INCBIN "TextureCosmo_2_160x640x3.raw"
