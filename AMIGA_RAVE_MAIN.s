...
Demo:			;a4=VBR, a6=Custom Registers Base addr
	...
	LEA	COPWAITSSRC\.gradient1,A2	; PRELOAD DEST
	...
	LEA	COPWAITSSRC\.gradient2,A2	; PRELOAD DEST
	...
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bwid/2,A3	; NOW 3 BPLS
	LEA	X_TEXTURE_MIRROR+TEXTURE_H*bwid,A4	; FILLS A PLANE
...
MainLoop:
	...
	;MOVE.L	A3,A0
	;LEA	COPPER\.BplPtrs,A1
	;BSR.W	PokePtrs		; NO DOUBLEBUF FOR FIRST PLANE
...
__FILL_MIRROR_TEXTURE:
	...
	DBRA	D6,.innerloop
	MOVE.L	#$AAAAAAAA,(A4)
	MOVE.L	#$55555555,4(A4)
	MOVE.L	#$AAAAAAAA,8(A4)
	MOVE.L	#$0,12(A4)
	MOVE.L	#$AAAAAAAA,16(A4)
	LEA	-40(A3),A3
	LEA	-60(A4),A4
	DBRA	D4,.outerloop
	RTS
...
__BLOCK_0:
	...
	;BTST	#6,$BFE001
	;BEQ.W	.DontShowRasterTime

	;## DUAL BUFFERING FOR NEXT TWO BITPLANES ONLY ##
	...
	MOVE.L	#0,BLIT_A_MOD
	MOVE.L	DrawBuffer,A4
	ADD.L	#((he/2)+HREAL+HREAL)*bypl,A4
	...
	NEG.W	D3
	MOVE.L	ViewBuffer,A3
	ADD.L	#HREAL*2*bypl,A3
	MOVE.L	DrawBuffer,A4
	ADD.L	#HREAL*2*bypl,A4
	BSR.W	__VIEW_2_DRAW		; DUMMY
	MOVE.L	A4,A3
...
;********** Fastmem Data **********
TIMELINE:		DC.L __BLOCK_0,__BLOCK_0,__BLOCK_0,__BLOCK_0
		DC.L __BLOCK_0000,__BLOCK_0000,__BLOCK_0000,__BLOCK_0000
...
X_TEXTURE_MIRROR:	INCBIN "TextureFractal_160x640x3.raw"
		;INCBIN "TEST_160x640x3.raw"
		;INCBIN "TextureCosmo_3_160x640x3.raw"
		DS.B TEXTURE_H*bwid/2	; mirrored texture
;*******************************************************************************
	SECTION "ChipBuffers",BSS_C	;BSS doesn't count toward exe size
;*******************************************************************************

BLEEDTOP:		DS.B hbleed*bypl*2
SCREEN1:		DS.B he/2*bypl
		DS.B hbleed*bypl
		DS.B he/2*bypl
		DS.B hbleed*bypl
		DS.B he/2*bypl
		DS.B hbleed*bypl
BLEEDTOP2:	DS.B hbleed*bypl*2
SCREEN2:		DS.B he/2*bypl
		DS.B hbleed*bypl
		DS.B he/2*bypl
		DS.B hbleed*bypl
		DS.B he/2*bypl
