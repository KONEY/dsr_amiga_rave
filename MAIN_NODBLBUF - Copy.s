...
__SCROLL_X_1_4_BIS:
	...
	BEQ.B	.notDesc
	; ## MAIN BLIT ####
	BSET	#$1,D1			; BLTCON1 BIT 12 DESC MODE
	ADD.W	D6,A5
	;ADD.W	D6,A6
	...
	;MOVE.L	#$FFFFFFFF,BLTAFWM		; THEY'LL NEVER
	MOVE.L	D2,BLTAFWM		; OPTIMIZATION - MASK LOADED GLOBALLLY

	MOVE.L	D1,BLTCON0		; BLTCON0
	;MOVE.W	D2,BLTCON1
...
__SCROLL_COMBINED:
	...
	BEQ.S	.skip
	BSR.W	__SCROLL_Y_HALF
	SUB.W	D1,A3			; D1 COMES FROM SUBROUTINE
	SUB.W	#1,A6
	CMP.W	#0,A6
	BNE.S	.skip
	MOVE.W	#1,A6
...
;********** Fastmem Data **********
TIMELINE:		DC.L __BLOCK_TEST,__BLOCK_0000,__BLOCK_0000,__BLOCK_0000,__BLOCK_0000
...
TEXTURE:		;INCBIN "PurpleT_160x640x3.raw"
		;INCBIN "TextureFractal_160x640x3.raw"
		;INCBIN "TEST_160x640x3.raw"
		INCBIN "TextureCosmo_160x640x3.raw"
...
BPL_PRECALC:	DS.W bypl*1	; Precalculated offsets
